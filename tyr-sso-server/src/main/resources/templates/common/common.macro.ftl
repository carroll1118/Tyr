...
<#macro commonHeader>
    <header class="main-header">
        <a href="${request.contextPath}/" class="logo">
            <span class="logo-mini"><b>Tyr</b></span>
            <span class="logo-lg"><b>TYR SSO</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="${request.contextPath}/logout"   >
                            <span class="hidden-xs">注销【${tyrUser.username}】</span>
                        </a>
                    </li>
                </ul>
            </div>
...
<#macro commonFooter >
    <footer class="main-footer">
        Powered by <b>TYR-SSO</b> 1.1.1-SNAPSHOT
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2018-${.now?string('yyyy')} &nbsp;
                <a href="https://www.xuxueli.com/" target="_blank" >carroll</a>
                &nbsp;
                <a href="https://github.com/xuxueli/tyr-sso" target="_blank" >github</a>
